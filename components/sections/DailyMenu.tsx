...
export default function DailyMenu() {
  ...
  return (
    <section className="py-12 md:py-20 px-4 bg-jirafa-light relative overflow-hidden min-h-[80vh]">
      <div
        className="absolute top-0 right-0 w-96 h-96 bg-jirafa-green/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"
        aria-hidden="true"
      ></div>
      <div
        className="absolute bottom-0 left-0 w-64 h-64 bg-orange-100/30 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"
        aria-hidden="true"
      ></div>
      ...
      >
        <header ref={titleRef} className="shrink-0 opacity-0 mb-6 md:mb-0">
          <div className="w-64 h-64 rounded-full border-4 border-jirafa-bg bg-white shadow-xl flex flex-col items-center justify-center text-center p-6 relative transform rotate-[-5deg] hover:rotate-0 transition-transform duration-500 group">
            ...
            <div
              className="text-6xl text-jirafa-green my-2 opacity-80 group-hover:scale-110 transition-transform duration-300"
              aria-hidden="true"
            >
              <UtensilsIcon className="w-16 h-16" />
            </div>
            <span className="font-sans font-light text-2xl tracking-widest text-gray-700 mt-2">
              SEMANAL
            </span>
          </div>
        </header>
        ...
        <div className="grow w-full space-y-6">
          <ul ref={listRef} className="space-y-4" aria-label="Platos del menú semanal">
            {DAILY_SPECIALS.map(special => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="hidden sm:block w-px h-10 bg-gray-200" aria-hidden="true"></div>
                  <div>
            ...
            <li className="flex items-center bg-orange-50 p-4 rounded-xl border border-orange-100 shadow-sm opacity-0 hover:shadow-md transition-all">
              <div
                className="w-12 h-12 rounded-full bg-orange-200 flex items-center justify-center text-orange-700 shrink-0"
                aria-hidden="true"
              >
          ...
          <footer ref={infoRef} className="grid md:grid-cols-2 gap-4 pt-4 opacity-0">
            <div className="bg-white/80 p-4 rounded-lg border border-gray-100 flex items-start gap-3">
              <div
                className="bg-jirafa-green/10 p-2 rounded-full text-jirafa-green"
                aria-hidden="true"
              >
            ...
            <div className="bg-white/80 p-4 rounded-lg border border-gray-100 flex items-start gap-3">
              <div className="bg-blue-50 p-2 rounded-full text-blue-500" aria-hidden="true">
